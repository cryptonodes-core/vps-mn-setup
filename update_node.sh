...
TARBALLURL="https://github.com/cryptonodes-core/cryptonodes-core/releases/download/v1.4.0/cryptonodes-1.4.0-x86_64-linux-gnu.tar.gz"
TARBALLNAME="cryptonodes-1.4.0-x86_64-linux-gnu.tar.gz"
CNMCVERSION="1.4.0"
